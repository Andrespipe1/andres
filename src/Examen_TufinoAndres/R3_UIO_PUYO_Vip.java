...
public class R3_UIO_PUYO_Vip extends Vip{
    ...
    public R3_UIO_PUYO_Vip(int cedula, String nombre, int idTicket, String fechaViaje, int nAsiento, String lugarAsiento, int nMaletas,int recargo, String placaBus, int horasViaje, double precioPasaje) {
