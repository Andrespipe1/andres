...
public class R2_UIO_TLC_vip extends Vip{
    ...
    public R2_UIO_TLC_vip(int cedula, String nombre, int idTicket, String fechaViaje, int nAsiento, String lugarAsiento, int nMaletas,double recargo, String placaBus, int horasViaje, double precioPasaje) {
