...
public class R1_UIO_GYE_Vip extends Vip {
    ...
    public R1_UIO_GYE_Vip(int cedula, String nombre, int idTicket, String fechaViaje, int nAsiento, String lugarAsiento, int nMaletas,int recargo, String placaBus, int horasViaje, double precioPasaje) {
