...
public class R4_UIO_RIOB_Vip extends Vip {
    ...
    public R4_UIO_RIOB_Vip(int cedula, String nombre, int idTicket, String fechaViaje, int nAsiento, String lugarAsiento, int nMaletas,double recargo, String placaBus, int horasViaje, double precioPasaje) {
