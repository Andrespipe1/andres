...
public class R4_UIO_RIOB extends Normal{
    public String placaBus;
    public int horasViaje;
    public double precioPasaje;

    public R4_UIO_RIOB(int cedula, String nombre, int idTicket, String fechaViaje, int nAsiento, String lugarAsiento, int nMaletas, String placaBus, int horasViaje, double precioPasaje) {
